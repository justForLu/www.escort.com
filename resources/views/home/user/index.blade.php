    ...
    <section class="clearfix person-function">
        <div class="container">
            <ul>
                ...
                <li><a href="{{url("/home/user/escort_info")}}"><i class="fa fa-th-large fa-2x" style=" content: attr(data-text); background: linear-gradient(to right, #da8cff, #9a55ff); -webkit-background-clip: text; color: transparent;"></i>Escort管理</a><span><i class="fa fa-angle-right fa-2x"></i></span></li>
